export default { 
    ...
    books: [
        { comments: [], code: 0, futured: false, name:  "Depeche Mode: Обнаженные до костей", author: "Джонатан Миллер", price: 507, type: "Искусство", seria: "Дискография", img: require('../../image/artbook1.jpg'),
        ...
        { comments: [], code: 1, futured: false, name:  "Об искусстве", author: "	Леонардо да Винчи", price: 382, type: "Детектив", seria: "Искусство", img: require('../../image/artbook2.jpg'),
        ...
        { comments: [], code: 2, futured: false, name:  "Скетчбук художника.", author: "	Кэти Джонсон", price: 507, type: "Искусство", seria: "МИФ. Творчество", img: require('../../image/artbook3.jpg'),
        ...
        { comments: [], code: 3, futured: false, name:  "Фотография. Для тех, кто хочет все успеть", author: "Мариам Акопян", price: 102, type: "Искусство", seria: "Энциклопедия быстрых знаний", img: require('../../image/artbook4.jpg'),
        ...
        { comments: [], code: 4, futured: false, name:  "MARVEL. Полная энциклопедия вселенной", author: "АСТ", price: 613, type: "Искусство", seria: "	Марвел. Энциклопедия", img: require('../../image/artbook5.jpg'),
        ...
        { comments: [], code: 5, futured: false, name:  "Человек-Паук. Энциклопедия персонажей", author: "Дэниел Уоллес", price: 507, type: "Искусство", seria: "	Марвел. Энциклопедия", img: require('../../image/artbook6.jpg'),
        ...
        { comments: [], code: 6, futured: false, name:  "Гончарное дело. Техника. Приемы. Изделия", author: "Александр Поверин", price: 553, type: "Хобби", seria: "Золотая библиотека увлечений", img: require('../../image/hobbybook1.jpg'),
        ...
        { comments: [], code: 7, futured: false, name:  "Техника Кимекоми. Японский стиль в интерьере", author: "Мария Ильницкая", price: 507, type: "Хобби", seria: "Золотая библиотека увлечений", img: require('../../image/hobbybook2.jpg'),
        ...
        { comments: [], code: 8, futured: false, name:  "Русская охота", author: "Леонид Сабанеев", price: 181, type: "Хобби", seria: "", img: require('../../image/hobbybook3.jpg'),description: "'Русская охота' - это уникальное собрание практических \
        ...
        { comments: [], code: 9, futured: false, name:  "Маленькие слабости сильной половины: Большая книга мужских хобби и увлечений", author: "Дэниел Уоллес", price: 507, type: "Хобби", seria: "", img: require('../../image/hobbybook4.jpg'),
        ...
        { comments: [], code: 10, futured: false, name:  "Хобби для мужчин 2009", author: "Дэниел Уоллес", price: 507, type: "Хобби", seria: "", img: require('../../image/hobbybook5.jpg'),description: "Человек-Паук - определённо один из величайших \
        ...
        { comments: [], code: 11, futured: false, name:  'Братство Кольца', author: 'Дж. Р. Р. Толкин', price: 260, type: 'Фэнтези', seria: 'Властели́н коле́ц', img: require('../../image/lotr1.jpg'), rating: 0, inStock: true,
        ...
        ,{ comments: [], code: 12, futured: false, name:  'Две крепости', author: 'Дж. Р. Р. Толкин', price: 260, type: 'Фэнтези', seria: 'Властели́н коле́ц ', img: require('../../image/lotr2.jpg'), rating: 0, inStock: true,
        ...
        ,{ comments: [], code: 13, futured: false, name:  'Возвращение короля', author: 'Дж. Р. Р. Толкин', price: 260, type: 'Фэнтези', seria: 'Властели́н коле́ц ', img: require('../../image/lotr3.jpg'), rating: 0, inStock: true,
        ...
        ,{ comments: [], code: 14, futured: false, name:  'Живые и мёртвые', author: 'Константин Симонов', price: 260, type: 'История', seria: '', img: require('../../image/lad.jpg'), rating: 0, inStock: true,
        description:'О книге: роман-эпопея о войне, сюжет охватывает время с июня 1941 по июль 1944 года.'}
        ,{ comments: [], code: 15, futured: false, name:  'Судьба человека', author: 'Дмитрий Русo', price: 260, type: 'История', seria: '', img: require('../../image/sp.jpg'), rating: 0, inStock: true,
        description:'О книге: повесть, герой которой, пережив войну, голод, потерю родных, усыновляет мальчика-сироту.'}
        ,{ comments: [], code: 16, futured: false, name:  'Звезда', author: 'Эммануил Казакевич', price: 260, type: 'История', seria: '', img: require('../../image/star.jpg'), rating: 0, inStock: true,
        ...
        ,{ comments: [], code: 17, futured: false, name:  'Военный лётчик', author: 'Антуан де Сент-Экзюпери', price: 260, type: 'История', seria: '', img: require('../../image/af.jpg'), rating: 0, inStock: true,
        ...
        ,{ comments: [], code: 18, futured: false, name:  "Исход", author: "Дмитрий Рус", price: 273, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 7", img: require('../../image/ptl7.jpg'), description: "Человечество заигралось с виртуальностью, \
        ...
        вжимает в плечо приклад исцарапанного ПТРД и хрипло орет: «Патрон!»…", rating: 4, inStock: true}
        ,{ comments: [], code: 19, futured: false, name:  "Долг", author: "Дмитрий Рус", price: 245, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 3", img: require('../../image/ptl3.jpg'), description: "Новая реальность обретает глубину и краски. \
        ...
        и боги содрогаются от человеческой жестокости.", rating: 5, inStock: true}
        ,{ comments: [], code: 20, futured: false, name:  "Срыв", author: "Дмитрий Рус", price: 260, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 1", img: require('../../image/ptl1.jpg'), description: "Невероятный феномен Срыва всколыхнул мир. \
        ...
        добровольно погрузился в бескрайний мир меча и магии?", rating: 4, inStock: true}
        ,{ comments: [], code:21, futured: false, name:  "Клан", author: "Дмитрий Рус", price: 291, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 2", img: require('../../image/ptl2.jpg'), description: "Оцифрованные люди в виртуальном мире… \
        ...
        могучих противников?", rating: 4, inStock: true}
        ,{ comments: [], code: 22, futured: false, name:  "Инферно", author: "Дмитрий Рус", price: 221, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 4", img: require('../../image/ptl4.jpg'), description: "Ткань Реальности трещит по швам. \
        ...
        ,{ comments: [], code: 23, futured: false, name:  "Война", author: "Дмитрий Рус", price: 242, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 6", img: require('../../image/ptl6.jpg'), description: "Бушует магическое пламя. Плавится сталь \
        ...
        отыскав путь домой, на Землю?!", rating: 5, inStock: true}
        ,{ comments: [], code: 24, futured: false, name:  "Битва", author: "Дмитрий Рус", price: 242, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 5", img: require('../../image/ptl5.jpg'), description: "Земля русского кластера дрожит от поступи \
        ...
        если за спиной — испуганные детские глаза и биение сердец тысяч доверившихся тебе людей.", rating: 4, inStock: true}
        ,{ comments: [], code: 25, futured: false, name:  "Кладбище Кроссбоунз", author: "Кейт Родс", price: 260, type: "Детектив", seria: "", img: require('../../image/dbook1.jpg'),description: "Элис Квентин, в прошлом жертва семейного насилия, до сих \
        ...
        ,{ comments: [], code: 26, futured: false, name:  "Седьмая свеча", author: "Сергей Пономаренко", price: 120, type: "Детектив", seria: "", img: require('../../image/dbook2.jpg'),description: "Глеб всегда недолюбливал тещу из-за ее удивительной \
        ...
        теперь уж не до смеха… " , rating: 5, inStock: true}
        ,{ comments: [], code: 27, futured: false, name:  "Легенда о Безголовом", author: "Андрей Кокотюха", price: 320, type: "Детектив", seria: "", img: require('../../image/dbook3.jpg'),description: "Семейная жизнь киевского адвоката Ларисы Гайдук не \
        ...
        ,{ comments: [], code: 28, futured: false, name:  "Кукольник", author: "Лиам Пайпер", price: 200, type: "Триллер", seria: "", img: require('../../image/tbook1.jpg'),description: "Судьба любила Адама Кулакова. До поры. Счастливый муж и отец, \
        ...
        глупой тщеславной ошибки. Похоже, этот его секрет окажется слишком дорогостоящим. И не единственным в его семье… ", rating: 1, inStock: true}
        ,{ comments: [], code: 29, futured: false, name:  "Апелляция", author: "Джон Гришэм", price: 325, type: "Триллер", seria: "", img: require('../../image/tbook2.jpg'),description: "Крупная химическая корпорация, долгие годы отравлявшая питьевую воду, \
        ...
        любую подлость, лишь бы не платить людям. Игра еще не закончена, считает он, намереваясь привести в действие особый план, способный до основания разрушить дело изнутри...", rating: 2, inStock: true}
        ,{ comments: [], code: 30, futured: false, name:  "Употребитель", author: "Алма Катсу", price: 100, type: "Триллер", seria: "", img: require('../../image/tbook3.jpg'),description: "Темной ночью в больницу маленького городка Сент-Эндрю привозят молодую \
