export default { 
    ...
    books: [
        ...
        { code: 2, futured: false, name:  "Скетчбук художника.", author: "	Кэти Джонсон", price: 507, type: "Искусство/Фотография", seria: "МИФ. Творчество", img: require('../../image/artbook3.jpg'),
        ...
        { code: 3, futured: false, name:  "Фотография. Для тех, кто хочет все успеть", author: "Мариам Акопян", price: 102, type: "Искусство/Фотография", seria: "Энциклопедия быстрых знаний", img: require('../../image/artbook4.jpg'),
        ...
        { code: 4, futured: false, name:  "MARVEL. Полная энциклопедия вселенной", author: "АСТ", price: 613, type: "Искусство/Фотография", seria: "	Марвел. Энциклопедия", img: require('../../image/artbook5.jpg'),
        ...
        { code: 5, futured: false, name:  "Человек-Паук. Энциклопедия персонажей", author: "Дэниел Уоллес", price: 507, type: "Искусство/Фотография", seria: "	Марвел. Энциклопедия", img: require('../../image/artbook6.jpg'),
        ...
        { code: 6, futured: false, name:  "Гончарное дело. Техника. Приемы. Изделия", author: "Александр Поверин", price: 553, type: "Хобби", seria: "Золотая библиотека увлечений", img: require('../../image/hobbybook1.jpg'),
        ...
        { code: 7, futured: false, name:  "Техника Кимекоми. Японский стиль в интерьере", author: "Мария Ильницкая", price: 507, type: "Хобби", seria: "Золотая библиотека увлечений", img: require('../../image/hobbybook2.jpg'),
        ...
        { code: 8, futured: false, name:  "Русская охота", author: "Леонид Сабанеев", price: 181, type: "Хобби", seria: "", img: require('../../image/hobbybook3.jpg'),description: "'Русская охота' - это уникальное собрание практических \
        ...
        { code: 9, futured: false, name:  "'Маленькие слабости' сильной половины: Большая книга мужских хобби и увлечений", author: "Дэниел Уоллес", price: 507, type: "Хобби", seria: "", img: require('../../image/hobbybook4.jpg'),
        ...
        { code: 10, futured: false, name:  "Хобби для мужчин 2009", author: "Дэниел Уоллес", price: 507, type: "Хобби", seria: "", img: require('../../image/hobbybook5.jpg'),description: "Человек-Паук - определённо один из величайших \
        ...
        { code: 11, futured: false, name:  'Братство Кольца', author: 'Дж. Р. Р. Толкин', price: 260, type: 'Фэнтези', seria: 'Властели́н коле́ц', img: require('../../image/lotr1.jpg'), rating: 0, inStock: true,
        ...
        ,{ code: 12, futured: false, name:  'Две крепости', author: 'Дж. Р. Р. Толкин', price: 260, type: 'Фэнтези', seria: 'Властели́н коле́ц ', img: require('../../image/lotr2.jpg'), rating: 0, inStock: true,
        ...
        ,{ code: 13, futured: false, name:  'Возвращение короля', author: 'Дж. Р. Р. Толкин', price: 260, type: 'Фэнтези', seria: 'Властели́н коле́ц ', img: require('../../image/lotr3.jpg'), rating: 0, inStock: true,
        ...
        ,{ code: 14, futured: false, name:  'Живые и мёртвые', author: 'Константин Симонов', price: 260, type: 'История', seria: '', img: require('../../image/lad.jpg'), rating: 0, inStock: true,
        description:'О книге: роман-эпопея о войне, сюжет охватывает время с июня 1941 по июль 1944 года.'}
        ,{ code: 15, futured: false, name:  'Судьба человека', author: 'Дмитрий Русo', price: 260, type: 'История', seria: '', img: require('../../image/sp.jpg'), rating: 0, inStock: true,
        description:'О книге: повесть, герой которой, пережив войну, голод, потерю родных, усыновляет мальчика-сироту.'}
        ,{ code: 16, futured: false, name:  'Звезда', author: 'Эммануил Казакевич', price: 260, type: 'История', seria: '', img: require('../../image/star.jpg'), rating: 0, inStock: true,
        ...
        ,{ code: 17, futured: false, name:  'Военный лётчик', author: 'Антуан де Сент-Экзюпери', price: 260, type: 'История', seria: '', img: require('../../image/af.jpg'), rating: 0, inStock: true,
        ...
        ,{ code: 18, futured: false, name:  "Исход", author: "Дмитрий Рус", price: 273, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 7", img: require('../../image/ptl7.jpg'), description: "Человечество заигралось с виртуальностью, \
        ...
        ,{ code: 19, futured: false, name:  "Долг", author: "Дмитрий Рус", price: 245, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 3", img: require('../../image/ptl3.jpg'), description: "Новая реальность обретает глубину и краски. \
        ...
        ,{ code: 20, futured: false, name:  "Срыв", author: "Дмитрий Рус", price: 260, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 1", img: require('../../image/ptl1.jpg'), description: "Невероятный феномен Срыва всколыхнул мир. \
        ...
        ,{ code:21, futured: false, name:  "Клан", author: "Дмитрий Рус", price: 291, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 2", img: require('../../image/ptl2.jpg'), description: "Оцифрованные люди в виртуальном мире… \
        ...
        ,{ code: 22, futured: false, name:  "Инферно", author: "Дмитрий Рус", price: 221, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 4", img: require('../../image/ptl4.jpg'), description: "Ткань Реальности трещит по швам. \
        ...
        ,{ code: 23, futured: false, name:  "Война", author: "Дмитрий Рус", price: 242, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 6", img: require('../../image/ptl6.jpg'), description: "Бушует магическое пламя. Плавится сталь \
        ...
        ,{ code: 24, futured: false, name:  "Битва", author: "Дмитрий Рус", price: 242, type: "ЛитРПГ", seria: "Играть чтобы жить. Книга 5", img: require('../../image/ptl5.jpg'), description: "Земля русского кластера дрожит от поступи \
        ...
        ,{ code: 25, futured: false, name:  "Кладбище Кроссбоунз", author: "Кейт Родс", price: 260, type: "Детектив", seria: "", img: require('../../image/dbook1.jpg'),description: "Элис Квентин, в прошлом жертва семейного насилия, до сих \
        ...
        ,{ code: 26, futured: false, name:  "Седьмая свеча", author: "Сергей Пономаренко", price: 120, type: "Детектив", seria: "", img: require('../../image/dbook2.jpg'),description: "Глеб всегда недолюбливал тещу из-за ее удивительной \
        ...
        ,{ code: 27, futured: false, name:  "Легенда о Безголовом", author: "Андрей Кокотюха", price: 320, type: "Детектив", seria: "", img: require('../../image/dbook3.jpg'),description: "Семейная жизнь киевского адвоката Ларисы Гайдук не \
        ...
        ,{ code: 28, futured: false, name:  "Кукольник", author: "Лиам Пайпер", price: 200, type: "Триллер", seria: "", img: require('../../image/tbook1.jpg'),description: "Судьба любила Адама Кулакова. До поры. Счастливый муж и отец, \
        ...
        ,{ code: 29, futured: false, name:  "Апелляция", author: "Джон Гришэм", price: 325, type: "Триллер", seria: "", img: require('../../image/tbook2.jpg'),description: "Крупная химическая корпорация, долгие годы отравлявшая питьевую воду, \
        ...
        ,{ code: 30, futured: false, name:  "Употребитель", author: "Алма Катсу", price: 100, type: "Триллер", seria: "", img: require('../../image/tbook3.jpg'),description: "Темной ночью в больницу маленького городка Сент-Эндрю привозят молодую \
